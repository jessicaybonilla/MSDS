...
This is a breakdown of every shooting incident that occurred in NYC going back to 2006 through the end of the 2024. Each record represents a shooting incident in NYC and includes information about the event, the location and time of occurrence. In addition, the data analysis includes a focus on monthly patterns, geographic distribution, and borough frequency.
